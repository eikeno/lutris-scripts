...
SLUG="$(string_to_slug.sh "$GAME_NAME")""-amiga"
...
fsuae:
  fdvolume: '50'
  kickstart_ext_file: /storage/GAMES_MASTER/LUTRIS/LUTRIS_RETRO/FS-UAE/Kickstarts/kick40060.CD32.ext
  kickstart_file: /storage/GAMES_MASTER/LUTRIS/LUTRIS_RETRO/FS-UAE/Kickstarts/kick40060.CD32
  model: CD32
game:
  cdrom_image: ''
  main_file: "$@"
...
INSERT INTO games (name, slug, platform, runner, installed, installed_at, configpath, playtime, hidden) VALUES ( "$GAME_NAME", "$SLUG", "Amiga CD32", "fsuae", 1, $DATE_S, "$SLUG-$DATE_S", 0.0, 0);
EOT
