...
SLUG="$(string_to_slug.sh "$GAME_NAME")""-neogeocd"
...
INSERT INTO games (name, slug, platform, runner, installed, installed_at, configpath, playtime, hidden) VALUES ( "$GAME_NAME", "$SLUG", "NeoGeo CD", "libretro", 1, $DATE_S, "$SLUG-$DATE_S", 0.0, 0);
EOT
