...
INSERT INTO games (name, slug, platform, runner, installed, installed_at, configpath, playtime, hidden) VALUES ( "$GAME_NAME", "$SLUG", "Sega Megadrive", "libretro", 1, $DATE_S, "$SLUG-$DATE_S", 0.0, 0);
EOT
