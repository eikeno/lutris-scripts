...
destpattern="/storage/GAMES_MASTER/RETROARCH/thumbnails/Nintendo - GameCube/Named_Boxarts/%s.jpg"
...
if __name__ == '__main__':
	get_thumb_or_die_trying(
		"/storage/GAMES_MASTER/RETROARCH/playlists/Nintendo - GameCube.lpl",
		2
	)
	sys.exit(0)
