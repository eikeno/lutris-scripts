...
destpattern="/storage/GAMES_MASTER/RETROARCH/thumbnails/SNK_-_Neo_Geo/Named_Boxarts/%s.jpg"
...
def get_thumb_or_die_trying(json_pl_file, pfid):
	...
	with open(json_pl_file) as f:
		...
		for i in items:
			...
			with open((destpattern % label).replace(
					" / ", " "
				), "wb") as final_img:
...
if __name__ == '__main__':
	get_thumb_or_die_trying(
		"/storage/GAMES_MASTER/RETROARCH/playlists/SNK - Neo Geo.lpl",
		24
	)
	sys.exit(0)
